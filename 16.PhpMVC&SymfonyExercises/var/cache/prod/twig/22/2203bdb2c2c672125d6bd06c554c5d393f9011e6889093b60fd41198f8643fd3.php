...
class __TwigTemplate_4e78505dc3e7ce429706acc76c4086df693a04da165d4212429be242868d84a2 extends Twig_Template
{
                    ...
                    <div class=\"form-group\">
                        <div class=\"col-sm-4 \">
                            <select class=\"form-control\" name=\"calculator[operator]\">
                                <option value=\"+\" ";
        // line 18
        echo (((array_key_exists("calculator", $context) && ($this->getAttribute((isset($context["calculator"]) ? $context["calculator"] : null), "operator", array()) == "+"))) ? ("selected") : (""));
        echo ">+</option>
                                <option value=\"-\" ";
        // line 19
        echo (((array_key_exists("calculator", $context) && ($this->getAttribute((isset($context["calculator"]) ? $context["calculator"] : null), "operator", array()) == "-"))) ? ("selected") : (""));
                    ...
                    <div class=\"form-group\">
                        <div class=\"col-sm-4 \">
                            <input type=\"text\" class=\"form-control\" id=\"result\" placeholder=\"Result\"
                                   name=\"result\" value=\"";
        // line 46
        echo twig_escape_filter($this->env, (((array_key_exists("result", $context) &&  !(null === (isset($context["result"]) ? $context["result"] : null)))) ? ((isset($context["result"]) ? $context["result"] : null)) : ("")), "html", null, true);
        echo "\">
                        </div>
                    </div>
...
";
    ...
    {
        return array (  103 => 46,  97 => 42,  91 => 40,  89 => 39,  76 => 29,  65 => 21,  61 => 20,  57 => 19,  53 => 18,  43 => 11,  35 => 6,  31 => 4,  28 => 3,  11 => 1,);
    }
